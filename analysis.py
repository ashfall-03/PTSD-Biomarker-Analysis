...
# 2. Data Cleaning: Focus on biological integrity
...
# 4. Visualization: The 'Core' of Neuro-Analysis
...
# Proving you understand the significance of the biological markers
...
# 8. Regression Plot (Visualizing the trend line)
plt.figure(figsize=(10, 6))
